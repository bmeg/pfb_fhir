...
setup(
    ...
    description='Render a PFB graph from FHIR data',
    # Optional
    ...
    url='https://github.com/bmeg/pfb_fhir',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='bmeg.io',  # Optional
    ...
    keywords='PFB AnVIL terra gen3 bioinformatics fhir',  # Optional
